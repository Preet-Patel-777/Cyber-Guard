...
const features = [
  ...
  },
  {
    ...
    title: "Privacy First",
    description:
      "Your data never leaves your device. CyberGuard runs entirely in your browser with zero server-side storage.",
  },
  {
    icon: Zap,
      ...
      <div className="mx-auto max-w-7xl px-4 py-20 lg:px-8 lg:py-28">
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-pretty text-base leading-relaxed text-muted-foreground">
            From identifying the threat to filing an official report — CyberGuard
