...
function generateReportText(data: ReportFormData, attacks: DetectedAttack[]): string {
  ...
  lines.push("CYBERGUARD — INCIDENT REPORT")
  lines.push("=" .repeat(60))
  lines.push("")
...
export function IncidentReport({ data, attacks }: IncidentReportProps) {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div
        ref={reportRef}
        className="rounded-xl border border-border bg-card shadow-sm print:border-none print:bg-transparent"
      >
        {/* Report header */}
        <div className="border-b border-border p-6 md:p-8 print:border-b print:border-gray-300">
        ...
        <div className="border-b border-border p-6 md:p-8 print:border-b print:border-gray-300">
          ...
          <div className="flex flex-col gap-5">
            {attacks.map((attack, i) => (
              <div
                key={attack.name}
                className="rounded-lg border border-border p-4 print:border print:border-gray-300"
              >
        ...
        <div className="p-6 md:p-8">
          ...
          <div className="mt-6 rounded-lg border border-border bg-secondary p-4 text-xs text-muted-foreground print:border print:border-gray-300 print:bg-gray-50 print:text-gray-500">
